...
function requireAuthJwt() {
  ...
  return jwt({
    ...
    path: [{
      ...
      methods: ["POST", "PUT"]
    }, "".concat(api, "/users/login"), "".concat(api, "/ratedmeals"), "".concat(api, "/ratings"), "".concat(api, "/orders/order")]
  });
}

// **expressJwt** offer a way to revoke one of the parameter passed in **jsonwebtoken**
function isRevokedCallback(_x, _x2, _x3) {
  return _isRevokedCallback.apply(this, arguments);
}
function _isRevokedCallback() {
  _isRevokedCallback = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, payload, done) {
