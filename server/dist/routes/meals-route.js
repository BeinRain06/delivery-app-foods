...
// FOR POST
router.post("/meal", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var newFood, category;
...
//GET DESSERTS
router.get("/desserts:dessertsId", /*#__PURE__*/function () {
...
router.get("/seafoods/:seafoodsId", /*#__PURE__*/function () {
...
router.get("/meats/:meatsId", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 3;
          return Meal.find({
            category: req.params.meatsId
          }).populate("category");
        case 3:
          meats = _context5.sent;
          res.json({
            success: true,
            data: meats
          });
...
router.get("/vegetarians/:vegetariansId", /*#__PURE__*/function () {
...
// FOR PUT (ADMIN)
router.use("/:mealId", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          _context7.next = 3;
          return Meal.findByIdAndUpdate(req.params.mealId, {
            $set: {
              name: req.body.name,
              image: req.body.image,
