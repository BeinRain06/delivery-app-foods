    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return newRatedMeal.save();
        case 5:
          newRatedMeal = _context.sent;
          //mongoDB save
...
router.put("/ratedmeal:ratedId", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var ratedId, updateInstance;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          console.log("rating on updation process");
          ratedId = req.params.ratedId;
          _context3.next = 5;
          return RatedMeal.findByIdAndUpdate(ratedId, {
            rating: req.body.rating,
